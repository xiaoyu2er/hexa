...
export const SonarPulse: FC<SonarPulseProps> = ({
  ...
  return (
    <div className="relative inline-block">
      <div
        className="relative flex items-center justify-center rounded-full bg-transparent text-center"
        style={{ width: `${size}px`, height: `${size}px` }}
      >
        {icon}
      </div>
      {children}
      <div className="-z-10 absolute top-1/2 left-1/2 overflow-visible">
        <div
