...
import { PauseBoldIcon, PlayBoldIcon } from '@/components/icons';
...
export const VideoInView: FC<VideoInViewProps> = ({
  ...
  const isVisible = useInView(videoRef as unknown as RefObject<Element>);
  ...
  return (
    ...
    >
      ...
      <video
        ...
        className={cn(
          'w-full rounded-xl border border-transparent object-fit shadow-lg dark:border-default-200/50',
          className
        )}
        controls={controls}
        height={height}
