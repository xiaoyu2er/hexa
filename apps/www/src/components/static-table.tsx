...
export const TableRoot: FC<ComponentProps<'div'>> = ({
  children,
  className,
  ...props
}) => {
...
export const TableRow: FC<ComponentProps<'tr'>> = ({
  children,
  className,
  ...props
}) => {
...
export const TableColumnHeader: FC<ComponentProps<'th'>> = ({
  children,
  className,
  ...props
}) => {
...
export const TableColumn: FC<ComponentProps<'th'>> = ({
  children,
  className,
  ...props
}) => {
