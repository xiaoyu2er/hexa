...
export function AnimatedBeamDemo() {
  ...
  const personRef1 = useRef<HTMLDivElement>(null);
  const personRef2 = useRef<HTMLDivElement>(null);
  const personRef3 = useRef<HTMLDivElement>(null);
