...
export const zDomainStatusEnum = z.enum([
  'active',
  'pending',
  'active_redeploying',
  'moved',
...
export type DomainStatus = z.infer<typeof zDomainStatusEnum>;

export const zSslStatusEnum = z.enum([
  'initializing',
  'pending_validation',
  'deleted',
  'pending_issuance',
...
export type SslStatus = z.infer<typeof zSslStatusEnum>;

export const zDomainTypeEnum = z.enum(['PUBLIC', 'CUSTOM']);
export type DomainType = z.infer<typeof zDomainTypeEnum>;

// Insert Domain Schema
export const InsertDomainSchema = createInsertSchema(domainTable, {
  hostname: zDomain,
}).pick({
  hostname: true,
  orgId: true,
...
export type SelectDomainType = z.infer<typeof SelectDomainSchema>;
